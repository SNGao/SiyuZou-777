...
::: callout-warning
In my Windows computer,it doesn't support wildcards like \* for remote file downloads using wget. So I specified the URLs of the files that I required to download
:::
...
# wget https://raw.githubusercontent.com/stephaniehicks/jhustatprogramming2023/main/data/*.fastq -OutFile "~/Desktop/raw_data/fastq"
